...
namespace MobileAgent.EventAgent
{
    ...
    {
        #region Fields
        public static int AGLET_PERSISTENCY_FIRST = 40;
        public static int AGLET_PERSISTENCY_LAST = 41;
        public static int DEACTIVATING = AGLET_PERSISTENCY_FIRST;
        public static int ACTIVATION = AGLET_PERSISTENCY_FIRST+1;
